...
**The datasets you can use for this assignment are located here: [Citi Bike Data](https://www.citibikenyc.com/system-data). You're not expected to use every dataset. They will not all load into Tableau. Use a time period of your choosing.**
